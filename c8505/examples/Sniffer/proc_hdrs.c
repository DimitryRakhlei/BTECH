...
--					Also code was taken from tcpdump source, namely the
following files..
--					print-ether.c
--					print-ip.c
--					ip.h
...
--	print out selected fields of interest. For TCP the payload is also printed
out.
--	Currently the only the IP and TCP header processing functionality has been
implemented.
-------------------------------------------------------------------------------------------------*/
...
void pkt_callback(u_char *args, const struct pcap_pkthdr *pkthdr,
                  const u_char *packet) {
...
// This function will parse the IP header and print out selected fields of
// interest
void handle_IP(u_char *args, const struct pcap_pkthdr *pkthdr,
               const u_char *packet) {
...
void handle_UDP(u_char *args, const struct pcap_pkthdr *pkthdr,
                const u_char *packet) {
    printf("Called Handle UDP\n");
