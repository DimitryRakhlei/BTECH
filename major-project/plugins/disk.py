...
class DiskCheckPointHook(Hook):
    ...
    def cleanup(self):
        print(self.configuration.get('delete_checkpoints', False))
...
def snapshot_to_checkpoint(volume, snapshot, folder_path):
    ...
    #example qemu-img convert -f qcow2 -O qcow2 -U -o backing_file=downloads/w7.qcow2 runtime/3444ece2-5b64-43ad-a3b4-88345373cf99/3444ece2-5b64-43ad-a3b4-88345373cf99 output.qcow2
    process = launch_process(QEMU_IMG, "convert", "-f", "qcow2", "-O", "qcow2", "-U", 
                            "-o", "backing_file=%s" % volume_backing_path(volume),
...
def volume_name(volume):
    ...
    return volume_element.find('name').text
